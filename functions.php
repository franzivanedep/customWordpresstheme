...
function phoenix_customize_register( $wp_customize ) {
    ...
    // LOGO UPLOAD (Replaced phoenix_site_title)
    $wp_customize->add_setting( 'phoenix_logo' );
    $wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'phoenix_logo', array(
        'label'    => 'Upload PNG Logo',
        'section'  => 'phoenix_header_section',
        'settings' => 'phoenix_logo',
    ) ) );
